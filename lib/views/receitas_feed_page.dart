...
// class ReceitasFeedPage extends StatefulWidget {
//   void Function() onNovaReceitaPressed;
//   ReceitasFeedPage({this.onNovaReceitaPressed});
//   @override
//   _ReceitasFeedPageState createState() => _ReceitasFeedPageState();
// }

// class _ReceitasFeedPageState extends State<ReceitasFeedPage> {
//   Screen screen;
...
//               itemBuilder: (_, index) {
//                 String categoria = categorias.elementAt(index);
//                 return _categoriaViewModel(categoria, index);
//               },
...
//       Receita receita = await ReceitasScrapingTudoGostoso().fetchReceita();
...
//         _adsCubit.sumHalf();
//         NavKeys.initialPage.currentState
//             .pushNamed(AppRoutes.receitaPage, arguments: receita.id);
//       },
//       child: Container(
